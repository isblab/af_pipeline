"""
<h1><strong><font>AF-Pipeline</strong></h1>

- Modules for parsing, analyzing, and assessing AlphaFold predictions.
...
<body>
    ...
    <iframe src="../docs/network_viz/network_af_pipeline.html" width="800" height="600" frameborder="0">
    </iframe>
</body>
"""